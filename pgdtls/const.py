...
GNUTLS_E_UNEXPECTED_PACKET = -15  # GNUTLS_A_UNEXPECTED_MESSAGE
GNUTLS_E_WARNING_ALERT_RECEIVED = -16
GNUTLS_E_ERROR_IN_FINISHED_PACKET = -18
GNUTLS_E_UNEXPECTED_HANDSHAKE_PACKET = -19
GNUTLS_E_UNKNOWN_CIPHER_SUITE = -21       # GNUTLS_A_HANDSHAKE_FAILURE
GNUTLS_E_UNWANTED_ALGORITHM = -22
GNUTLS_E_MPI_SCAN_FAILED = -23
GNUTLS_E_DECRYPTION_FAILED = -24  # GNUTLS_A_DECRYPTION_FAILED, GNUTLS_A_BAD_RECORD_MAC
GNUTLS_E_MEMORY_ERROR = -25
GNUTLS_E_DECOMPRESSION_FAILED = -26       # GNUTLS_A_DECOMPRESSION_FAILURE
...
GNUTLS_E_INSUFICIENT_CREDENTIALS = GNUTLS_E_INSUFFICIENT_CREDENTIALS      # for backwards compatibility only
GNUTLS_E_INSUFFICIENT_CRED = GNUTLS_E_INSUFFICIENT_CREDENTIALS
GNUTLS_E_INSUFICIENT_CRED = GNUTLS_E_INSUFFICIENT_CREDENTIALS     # for backwards compatibility only

GNUTLS_E_HASH_FAILED = -33
GNUTLS_E_BASE64_DECODING_ERROR = -34

GNUTLS_E_MPI_PRINT_FAILED = -35
GNUTLS_E_REHANDSHAKE = -37        # GNUTLS_A_NO_RENEGOTIATION
...
GNUTLS_E_NO_CERTIFICATE_FOUND = -49       # GNUTLS_A_BAD_CERTIFICATE
...
GNUTLS_E_RECEIVED_ILLEGAL_PARAMETER = -55 # GNUTLS_A_ILLEGAL_PARAMETER
...
GNUTLS_E_UNSUPPORTED_CERTIFICATE_TYPE = -61       # GNUTLS_A_UNSUPPORTED_CERTIFICATE
...
GNUTLS_E_MAC_VERIFY_FAILED = -100 # for PKCS #12 MAC
...
GNUTLS_E_INCOMPATIBLE_GCRYPT_LIBRARY = -202       # obsolete
...
def e_map():
	...
	for k, v in sys._getframe(1).f_locals.items():
		if not k.startswith("GNUTLS_E_"):
			pass
		elif k.endswith("_MAX") or k.endswith("_MIN"):
			minmax.setdefault(k[:-4], {})[k[-3:]] = v
		else:
			result[v] = k
	for k, d in minmax.items():
		for v in range(d["MIN"], d["MAX"] + 1):
			result[v] = k
	return result
GNUTLS_E_MAP = e_map()
del e_map
